...
var EuroMillionsDrawConfig = new React.createClass({
    ...
    render : function () {
        ...
        elem.push(<EmSelectDraw play_days={this.props.play_days} {...this.props} active={this.state.selectdrawactive} key="1"/>)
        ...
        elem.push(<EmSelectDrawDuration change_duration={this.props.duration} options={options_draw_duration} active={this.state.selectdrawactive} key="3"/>)
        return (
            <div>
                {elem}
            </div>
