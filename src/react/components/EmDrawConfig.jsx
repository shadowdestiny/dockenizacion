...
var EuroMillionsDrawConfig = new React.createClass({
    ...
    render : function () {
        ...
        var default_value_drawdate = draw_dates[0];
        var default_text_drawdate = draw_dates[0];
        ...
        elem.push(<EmSelectDrawDate change_date={this.props.date_play} defaultValue={default_value_drawdate} defaultText={default_text_drawdate} options={options_draw_dates} active={this.state.selectdrawactive} key="2"/>)
