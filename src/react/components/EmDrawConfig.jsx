...
var EuroMillionsDrawConfig = new React.createClass({
    ...
    render : function () {
        ...
        elem.push(<EmSelectDraw play_days={this.props.play_days} defaultValue={default_value_draw} defaultText={default_text_draw} options={options_draw_days} {...this.props} active={this.props.show_config} key="1"/>)
        elem.push(<EmSelectDrawDate change_date={this.props.date_play} defaultValue={default_value_date} defaultText={default_text_date} options={options_draw_dates} active={this.props.show_config} key="2"/>)
        elem.push(<EmSelectDrawDuration change_duration={this.props.duration} defaultValue={default_value_duration} defaultText={default_text_duration} options={this.props.draw_duration} active={this.props.show_config} key="3"/>)
        return (
            <div>
                {elem}
            </div>
