        ...
        if(!this.props.show) {
            ...
            return (
                <div className="advanced-play">
                    ...
                    <div className="cols">
                        <EmDrawConfig date_play={this.props.date_play} duration={this.props.duration} play_days={this.props.play_days}  options={options_draw_days} customValue={custom_value}/>
