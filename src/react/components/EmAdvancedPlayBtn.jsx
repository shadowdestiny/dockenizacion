...
var EuroMillionsAdvancedPlayBtn = new React.createClass({
    ...
    render : function () {
        return (
            <span>
            <a href="javascript:void(0);" className="btn big rwr advanced">Reset Advanced Settings <svg className="ico v-cross"><use xlinkHref="/w/svg/icon.svg#v-cross"></use></svg></a>
