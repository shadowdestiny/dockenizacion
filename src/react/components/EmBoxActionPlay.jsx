...
var EuroMilliosnBoxActionPlay = React.createClass({
    ...
    render : function() {
        ...
        var selectDrawDate = <EmSelectDrawDate change_date={this.props.date_play} change_date={this.props.date_play} defaultValue={default_value_date} defaultText={default_text_date} options={options_draw_dates} active={true}/>
