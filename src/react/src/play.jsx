            ...
            <div>
                ...
                <div className="box-bottom">
                    <div className="wrap">
                        ...
                        <EuroMillionsBoxBottomAction total_price_description={totalPriceDescription} description_before_price={descriptionBeforeButtonPrice} reset={this.handleResetStateAdvancedPlay} config_changed={this.state.config_changed} draw_day_play={this.state.draw_day_play} currency_symbol={this.props.currency_symbol} click_advanced_play={this.handleClickAdvancedPlay} date_play={this.state.date_play} duration={this.state.draws_number} play_days={this.state.playDays}  lines={this.state.storage}  price={total_price} txtNextButton={this.props.txtNextButton} />
