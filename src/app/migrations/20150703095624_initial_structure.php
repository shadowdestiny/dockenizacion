...
class InitialStructure extends AbstractMigration
{
    ...
    {
        $this->execute("CREATE TABLE euromillions_draws (draw_id INT UNSIGNED AUTO_INCREMENT NOT NULL, lottery_id INT UNSIGNED DEFAULT NULL, draw_date DATE NOT NULL, result_regular_numbers VARCHAR(255) DEFAULT NULL, result_lucky_numbers VARCHAR(255) DEFAULT NULL, jackpot_amount BIGINT NOT NULL, jackpot_currency_name VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_79652A5B38C98BF (draw_date), INDEX IDX_79652A5BCFAA77DD (lottery_id), PRIMARY KEY(draw_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB;");
        ...
        $this->execute("CREATE TABLE translations (translation_id INT UNSIGNED AUTO_INCREMENT NOT NULL, `key` VARCHAR(255) NOT NULL, used TINYINT(1) DEFAULT '0' NOT NULL, UNIQUE INDEX UNIQ_C6B7DA878A90ABA9 (`key`), PRIMARY KEY(translation_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB;");
