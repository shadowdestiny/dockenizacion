...
#}
		...
		<div class="special">
			...
			<span class="txt">{{ language.translate("A single bet in a line consist in 5 numbers + 2 star numbers. Do you want to make a bet with multiple numbers in a line?") }}<a href="/faq#n05">{{ language.translate("Yes, please.") }}</a></span>
		</div>
		<div class="gameplay">
