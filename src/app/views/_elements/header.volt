<header>
	<nav class="top-nav">
		<div class="wrapper">
			<ul>
				<li><a href="javascript:void(0);">Euro / English <span class="ico ico-pull-down"></span></a></li>
				<li><a href="javascript:void(0);">Help <span class="ico ico-pull-down"></span></a></li>
			</ul>
		</div>
	</nav>
	<div class="head">
				...
				<ul>
					<li class="active">
						<a href="javascript:void(0);">
							<span class="lnk">{{ language.translate("Win top prizes") }}</span>
					...
					<li>
						<a href="javascript:void(0);">
							<span class="lnk">{{ language.translate("Winning") }}
							</span>
					...
					<li>
						<a href="javascript:void(0);">
							<span class="lnk">{{ language.translate("Hello, Sign in") }}
							</span>
