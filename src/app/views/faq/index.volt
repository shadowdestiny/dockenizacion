        ...
        <div class="box-basic medium">
            ...
            <div class="questions">
                ...
                <ul class="no-li">
                    ...
                    <li><a href="#n01" data-ajax="false">What time is the draw?</a></li>
                    <li><a href="#n07" data-ajax="false">How do I play Euromillions?</a></li>
                    <li><a href="#n12" data-ajax="false">How long does it take for the results to be released?</a></li>
                    <li><a href="#n10" data-ajax="false">When I win playing Euromillions?</a></li>
                </ul>

                <h2 class="h3">Euromillions Advanced Play</h2>
                <ul class="no-li">
                    <li><a href="#n17" data-ajax="false">What is a Euromillions Superdraw?</a></li>
                    <li><a href="#n18" data-ajax="false">What is a Euromillions Subscription?</a></li>
                    <li><a href="#n08" data-ajax="false">How can I participate in a future draw?</a></li>
               ...
               <h2 class="h3">Winnings</h2>
                <ul class="no-li">
                    <li><a href="#n11" data-ajax="false">What are the odds of winning?</a></li>
                    <li><a href="#n14" data-ajax="false">How do I know if I have won a prize?</a></li>
                    <li><a href="#n16" data-ajax="false">How do I claim a prize?</a></li>
                    <li><a href="#n15" data-ajax="false">How long do I have to claim my prize?</a></li>
                    <li><a href="#n19" data-ajax="false">Are winnings on the Euromillions taxable?</a></li>
                </ul>

                <h2 class="h3">Account and Billings</h2>
                <ul class="no-li">
                    <li><a href="#n02" data-ajax="false">How much does a Euromillions ticket cost?</a></li>
                    <li><a href="#n09" data-ajax="false">What payment options and currency are accepted?</a></li>
                    <li><a href="#n03" data-ajax="false">What time do ticket sales close?</a></li>
                    <li><a href="{{ url("faq#n13") }}">Does the Euromillions have a rollover limit or jackpot cap?</a></li>
                    <li><a href="#">How do I track my past played games?</a></li>
                </ul>

                <h2 class="h3">Troubleshootings</h2>
                <ul class="no-li">
                    <li><a href="#n20" data-ajax="false">I have forgotten my password and I cannot login. What do I do?</a></li>
                ...
                <ul class="no-li">
                    <li><a href="#n06" data-ajax="false">What is the minimum guaranteed jackpot?</a></li>
                    <li><a href="#n05" data-ajax="false">Can I play on Euromillions from any country</a></li>
                    <li><a href="#n04" data-ajax="false">Is there a minimum age limit for playing?</a></li>
                </ul>
            </div>
            <div class="answer">
                <a id=""></a>
                ...
                <a href="{{ url("faq#top") }}" class="back" data-ajax="false"><i class="ico ico-arrow-up2"></i> Back to the top</a>
                ...
                <a href="#top" class="back" data-ajax="false"><i class="ico ico-arrow-up2"></i> Back to the top</a>
