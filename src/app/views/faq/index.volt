        ...
        <div class="box-basic medium" data-ajax="false">
            ...
            <div class="questions">
                ...
                <ul class="no-li">
                    ...
                    <li><a href="#n09">{{ language.translate("What is an Auto-Play?") }}</a></li> 
                    <li><a href="#n10">{{ language.translate("Can I play only when the Jackpot Prize reach a specific ammount?") }}</a></li>
                    <li><a href="#n11">{{ language.translate("How do I make a bet with multiple numbers in a line?") }}</a></li>
                </ul>

               <h2 class="h3">{{ language.translate("Winnings") }}</h2>
                <ul class="no-li">
                    <li><a href="#n12">{{ language.translate("How do I know if I have won a prize?") }}</a></li>
                    <li><a href="#n13">{{ language.translate("How do I claim a prize?") }}</a></li>
                    <li><a href="#n14">{{ language.translate("How long do I have to claim my prize?") }}</a></li>
                    <li><a href="#n15">{{ language.translate("Are winnings on the Euromillions taxable?") }}</a></li>
                    <li><a href="#n16">{{ language.translate("What are the odds of winning?") }}</a></li>
                </ul>

                <h2 class="h3">{{ language.translate("Account and Billings") }}</h2>
                <ul class="no-li">
                    <li><a href="#n17">{{ language.translate("How much does a Euromillions ticket cost?") }}</a></li>
                    <li><a href="#n18">{{ language.translate("What payment options and currency are accepted?") }}</a></li>
                    <li><a href="#n19">{{ language.translate("What time do ticket sales close?") }}</a></li>
                    <li><a href="#n20">{{ language.translate("Does the Euromillions have a rollover limit or jackpot cap?") }}</a></li> 
                    <li><a href="#n21">{{ language.translate("How do I track my past played games?") }}</a></li>
                </ul>

                <h2 class="h3">{{ language.translate("Troubleshootings") }}</h2>
                <ul class="no-li">
                    <li><a href="#n22">{{ language.translate("What should I do if I am experiencing technical problems?") }}</a></li>
                    <li><a href="#n23">{{ language.translate("I have forgotten my password and I cannot login. What do I do?") }}</a></li>
                    <li><a href="#n24">{{ language.translate("How do I edit or delete a Euromillions Subscription?") }}</a></li>
                    <li><a href="#n25">{{ language.translate("I had problems to complete a purchase of a ticket. Who do I contact for help?") }}</a></li>
                    <li><a href="#n26">{{ language.translate("How I can disable emails notifications?") }}</a></li>
                </ul>

                <h2 class="h3">{{ language.translate("Legal") }}</h2>
                <ul class="no-li">
                    <li><a href="#n27">{{ language.translate("What is the minimum guaranteed jackpot?") }}</a></li>
                    <li><a href="#n28">{{ language.translate("Can I play on Euromillions from any country") }}</a></li>
                    <li><a href="#n29">{{ language.translate("Is there a minimum age limit for playing?") }}</a></li>
                </ul>
            </div>
            ...
            <div class="answer">
                ...
                <p>To win the Euromillions jackpot (Value current Jackpot) players need to match all 5 main numbers and 2 Lucky Stars. To win a Euromillions prize, players they just have to match 2 or more numbers. It is that easy to be a winner!<br>
                    If you want</p>
                {% include "faq/back-top.volt" %}
                ...
                <a id="n08"></a>
                <h3 class="h3">{{ language.translate("How I can partecipate to future Draws?") }}</h3>
                <p>xxx</p> 
                {% include "faq/back-top.volt" %}

                <a id="n09"></a>
                <h3 class="h3">{{ language.translate("What is an Auto-Play?") }}</h3>
                <p>xxx</p> 
                {% include "faq/back-top.volt" %}
                ...
                *write about sending automatic email* 
                {% include "faq/back-top.volt" %}
                ...
                <a id=""></a>
                <h3 class="h3">{{ language.translate("What time do Euromillions ticket sales close?") }}</h3>
                ...
                <a id=""></a>
                <h3 class="h3">{{ language.translate("Is there a minimum age limit for playing Euromillions?") }}</h3>
                <p>To be eligible to play Euromillions, all participants must be 18 years or over (16+ in the UK).</p>
                {% include "faq/back-top.volt" %}

                <a id=""></a>
                <h3 class="h3">What is the minimum guaranteed jackpot?</h3>
                <p>The minimum guaranteed jackpot is &euro;15 million. It can rollover until &euro;190 million.</p>
                {% include "faq/back-top.volt" %}

                <a id=""></a>
                <h3 class="h3">{{ language.translate("Can I participate in a future Euromillions draw?") }}</h3>
