...
use EuroMillions\web\controllers\ResultController;
use EuroMillions\web\vo\dto\OrderDTO;
use EuroMillions\web\vo\dto\UserDTO;

class MegaSenaResultController extends ResultController
{
    public function successAction()
    {
        $this->view->setViewsDir($_SERVER['DOCUMENT_ROOT'].'/../apps/web/views/'); ///var/www/public
        ...
        $result_order = $this->megaSenaService->get($user_id, $lotteryName);
