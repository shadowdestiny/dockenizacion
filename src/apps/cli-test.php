...
use EuroMillions\shared\config\bootstrap\TestCliBootstrapStrategy;
...
try {
    ...
    $bootstrap = new EuroMillions\shared\config\bootstrap\Bootstrap(new TestCliBootstrapStrategy(
