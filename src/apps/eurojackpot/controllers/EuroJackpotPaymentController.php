        ...
        if ($this->request->isGet()) {
            ...
            if (null != $user && isset($charge)) {
                try {
                    ...
                    $result = $powerball_service->play($user_id, $amount, $card, true, $isWallet, 'EuroJackpot');
            ...
            if ($credit_card_form->isValid($this->request->getPost()) == false) {
                ...
                if (null != $user) {
                    try {
                        ...
                        $result = $playService->playWithQueue($user_id, $amount, $card, $payWallet, $isWallet,'EuroJackpot', $this->paymentsCollection);
