...
class PaginationWidgetAdmin extends \Phalcon\Mvc\User\Component {
    ...
    public function __construct(\Phalcon\Paginator\AdapterInterface $paginator, $queryArray, $options = [], $page = null){
     ...
     * @return array
     */
    protected function getDefaultOptions($page)
    {
        return [
            'paramKey'     => $page,
            'separator'    => '...',
     ...
     * @return $this
     */
    public function setOptions($options, $page)
    {
        $this->_options = array_merge($this->getDefaultOptions($page), (array)$options);
        return $this;
    }
}