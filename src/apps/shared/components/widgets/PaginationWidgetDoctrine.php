...
class PaginationWidgetDoctrine extends \Phalcon\Mvc\User\Component {
    ...
    public function __construct($page ,$totalElements, $queryArray, $options = []){

        $this->total_pages = $totalElements>$this->limit?ceil($totalElements/$this->limit):1;
        $this->total_items = $totalElements;
        $this->current = $page;
        $this->before       = $page-1;
        $this->next         = $page+1;
