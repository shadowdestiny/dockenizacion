...
class CartController extends \EuroMillions\web\controllers\PublicSiteControllerBase
{
    ...
    const PAYMENT_SELECTOR_TYPE = PaymentSelectorType::CREDIT_CARD_METHOD; //TODO: remove when the selector on the frontend is done. Must equals value at web/.../CartController.php

    protected $eventsManager;

    /** @var FeatureFlagApiService */
    protected $apiFeatureFlagService;
    ...
    public function initialize(
        ...
        $this->apiFeatureFlagService = $this->domainServiceFactory->getServiceFactory()->getFeatureFlagApiService();
     ...
     * @return \Phalcon\Mvc\View
     */
    protected function dataOrderView(
        $user,
        $result,
        $formErrors,
        $msg,
