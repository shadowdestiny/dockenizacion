<div class="review_and_pay-section">
    <section class="section--review-and-pay">
        <div class="top-row">
            ...
            <p>By purchasing you agree to Terms & Conditions</p>
        </div>
        ...
        <div class="section--content">
            ...
            <div class="total-row">
                ...
                <h3 class="right">
                    total amaount to be payed <span class="">12.00</span>
                </h3>
            </div>
            ...
            <h4>Lottery <span>(Euro millions)</span>
            </h4>
            <h4>
                Tickets x <span>3</span>
            </h4>
            <h4>
                May 16 2017
            </h4>
            <p>
                This order is for Euromillions lottery
            </p>
            <p>
        ...
        <div class="section--content">
            ...
            <div class="numbers--rows">
                <div class="numbers--row">
                    ...
                    <span class="cost-block">€3.00</span>
