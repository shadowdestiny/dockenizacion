...
<html>
<head>
    {% include "../../shared/views/_elements/meta.volt" %} {# META tags #}
            ...
            <script>
                window.onload = function () {
                    ...
                    if ( {{ countdown_finish_bet['diffTimeActualTimeAndNextDrawTime'] }} > {{ countdown_finish_bet['timeLimitAppearCountDown'] }} )
                    {
                        ...
                        if (window.location.pathname.split('/')[2] == 'play') {main.
                            setTimeout(function () {
...
{% include "../../shared/views/_elements/js-lib.volt" %} {# JS libraries #}
