...
class SuperEnalottoDrawDTO extends DTOBase implements IDto
{

    /** @var SuperEnalottoDrawBreakDownDTO $superEnalottoDrawBreakDownDTO */
    public $superEnalottoDrawBreakDownDTO;
    ...
    public function exChangeObject()
    {
        ...
        $this->superEnalottoDrawBreakDownDTO = new SuperEnalottoDrawBreakDownDTO($this->euromillionsDraw->getBreakDown());
    }
}