...
use EuroMillions\superenalotto\bootstrap\SuperEnalottoBootstrap;
...
try {
    ...
    $bootstrap = new EuroMillions\shared\config\bootstrap\Bootstrap(new SuperEnalottoBootstrap(
        $argv, $config_path
    ));
    $bootstrap->execute();
