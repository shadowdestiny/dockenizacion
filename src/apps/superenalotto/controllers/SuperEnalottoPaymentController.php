...
final class SuperEnalottoPaymentController extends PowerBallPaymentController
{
    private $lotteryName = "SuperEnalotto";
            ...
            if ($credit_card_form->isValid($this->request->getPost()) == false) {
                ...
                if (null != $user) {
                    try {
                        ...
                        if(!empty($result)) {
                            return $this->playResult($result, 'superenalotto');
                        }
