...
{% block template_scripts_code %}
    ...
    $.ajax({
    url:'/ajax/superenalotto-play-temporarily/temporarilyCart/',
    data:params,
    type:'POST',
    dataType:"json",
...
{% block body %}
    ...
    {% endif %}
    <main id="content">
        <div class="superenalotto--page">

            <div class="top-banner--superenalotto"></div>
            ...
            <div class="wrapper">
                ...
                {% include "_elements/superenalotto-header.volt" %}

                <div class="gameplay" id="gameplay"></div>

                {% include "_elements/superenalotto-bottom-block.volt" %}

            </div>

            <div id="closeticket" class="modal" style="width: {% if mobile == 1 %}250px;{% else %}1000px;{% endif %}height: 500px;">
                                        <div style="text-align: center;color:white">
                                            It is too late to buy SuperEnalotto tickets for the draw held tonight at 20:45 CET.
