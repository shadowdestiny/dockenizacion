...
{% block template_css %}
    ...
    <link Rel="Canonical" href="{{ language.translate('canonical_superenalotto_results') }}"/>
{% endblock %}
{% block bodyClass %}
    numbers
...
{% block template_scripts_code %}
    ...
    $.ajax({
    type: "POST",
    url: '/ajax/date-results/getSuperEnalottoDrawDaysByDate/',
    data: {
...
<script language="javascript">
    ...
    <main id="content">
        ...
        <div class="common--result-page--content superenalotto--result-page--content">
            ...
            <div class="wrapper">
                ...
                <div class="title-block">
                    ...
                    <ul class="no-li inline numbers">
                        ...
                        <li class="star">
                            <span class="num">x{{ last_result["megaplier_play"] }}</span>
                        </li>
                    </ul>
                    ...
                    <div class="left-section result-section">
                        ...
                        <div class="box-current-winners--new">
                            ...
                            <table id="current-winners" class="table ui-responsive" data-role="table"
                                ...
                                {% for i,line in break_downs %}
                                    <tr>
                                            <td class="td-ball">
                                                <span>
                                                    {{ line['name'] }} {{ language.translate("prizePool_ball") }}  {% if line['showMegaMillions'] == true %} + {{ language.translate("MegaBall") }} {% endif %}
                                                </span>
                                            </td>
                                            ...
                                            <td class="td-winners">
                                                <span>
                                                {{ line['winnersMegaMillions'] }}x
                                                </span>
                                            </td>
                                            <td class="td-prize">
                                                <span>
                                                  {{ symbol }} {{ line['megaMillionsPrize'] | number_format(2, '.', ',') }}
                                                </span>
                                            </td>
                                            ...
                                            {% else %}
                                                <span>
                                                    {{ symbol }} {{ line['megaplierPrize'] | number_format(2, '.', ',') }}
                                                </span>
                                             {% endif %}
                                            </td>
                                    </tr>
                            ...
                            <table id="current-winners-powerplay-mobile" class="table ui-responsive" data-role="table" style="display:none;"
                                ...
                                {% for i,line in break_downs %}
                                    <tr>
                                        <td class="td-ball">
                                                <span>
                                                    {{ line['name'] }} {{ language.translate("prizePool_ball") }} +  {{ language.translate("MegaBall") }}
                                                </span>
                                        </td>
                                        {#<td class="td-star-ball">#}
                                        {#{% if break_downs[name]['stars_corrected'] > 0 %}#}
                            ...
                            <div class="previous-results--common-row">
                                {% include "../../shared/views/_elements/previous-results-megamillions.volt" %}

                                <div class="previous-results--btn">

                                    <a href="/superenalotto/results/draw-history" class="btn-theme--big">
                                        <span class="resizeme">
