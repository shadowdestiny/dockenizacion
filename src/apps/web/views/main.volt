            ...
            {% if user_logged is defined and user_logged %}
                <div data-role="page" id="nav-account">
                    <ul class="no-li" data-role="listview">
                        ...
                        <li><a href="/profile/tickets/games" data-transition="slide" data-direction="reverse">{{ language.translate("Tickets") }}</a></li>
                        <li><a href="/account/wallet" data-transition="slide" data-direction="reverse">{{ language.translate("Balance") }}</a></li>
                        <li><a href="/profile/transactions" data-transition="slide" data-direction="reverse">{{ language.translate("Transactions") }}</a></li>
