...
#}
	...
	<aside class="logo-social cl">
		<div class="wrapper">
			<div class="social">
				<ul>
					<li class="fb"><a href="javascript:void(0);"><svg class="ico v-facebook"><use xlink:href="/w/svg/icon.svg#v-facebook"></use></svg><span class="txt">{{ language.translate('Facebook') }}</span></a></li>
					<li class="gp"><a href="javascript:void(0);"><svg class="ico v-google-plus"><use xlink:href="/w/svg/icon.svg#v-google-plus"></use></svg><span class="txt">{{ language.translate('Google +') }}</span></a></li>
