                ...
                <td class="numbers">
                    {% for i in 1..my_subscription_inactive['lines'] %}
                        <div class="numbers--row">
                            ...
                            {% if (my_subscription_inactive['name'] == 'MegaSena' or my_subscription_inactive['name'] == 'SuperEnalotto')%}
                            ...
                            {% endif %}
                            {% if (my_subscription_inactive['name'] != 'MegaSena' and my_subscription_inactive['name'] != 'SuperEnalotto')%}
