<ul class="no-li">
    ...
    <li><a {% if activeSubnav.myClass == "balance" %}class="active"{% endif %} href="/account/wallet">{{ language.translate("Balance") }} <svg class="ico v-arrow-right"><use xlink:href="/w/svg/icon.svg#v-arrow-right"></use></svg></a></li>
