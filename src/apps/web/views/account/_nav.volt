<ul class="no-li">
    ...
    <li><a {% if activeSubnav.myClass == "transaction" %}class="active"{% endif %} href="/account/transaction">{{ language.translate("Transaction") }} <i class="ico ico-arrow-right"></i></a></li>
