...
#}
    ...
    {#<li><a {% if activeSubnav.myClass == "email" %}class="active"{% endif %} href="/account/email">{{ language.translate("myAccount_email") }}#}
            {#<svg class="ico v-arrow-right"><use xlink:href="/w/svg/icon.svg#v-arrow-right"></use></svg>#}
        {#</a></li>#}
    {#<li><a {% if activeSubnav.myClass == "password" %}class="active"{% endif %} href="/account/password">{{ language.translate("myAccount_password") }}#}
            {#<svg class="ico v-arrow-right"><use xlink:href="/w/svg/icon.svg#v-arrow-right"></use></svg>#}
        {#</a></li>#}
</ul>
