    ...
    <div class="cl card-detail">
        ...
        <div class="left cvv">
            <label class="label" for="card-cvv">
                ...
                <span class="tooltip" data-message="The Card Code Verification is a 3 digit number (Mastercard and Visa) or 4 digit (American Express) that can be located on your card" data-class="v-question-mark ico" data-ico="v-question-mark"></span>
            </label>
    ...
    {% if component.where == 'account' %}
            ...
            <div class="col6 second">
                ...
                <div class="notes cl">
                    ...
                    <span class="txt" data-txt='{{ language.translate("Fee of")}} {{  fee }} {{ language.translate("will be charged for transfers less than ") }} {{ fee_to_limit }}' >{{ language.translate("Fee of")}} {{  fee }} {{ language.translate("will be charged for transfers less than ") }} {{ fee_to_limit }}</span>
