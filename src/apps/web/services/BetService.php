        ...
        if($user->getBalance()->getAmount() > $single_bet_price->getAmount()) {
            ...
            if(!empty($result)){
                ...
                try{
                    ...
                    foreach($bet->getPlayConfig()->getLine() as $line) {
                        $result_validation = $lotteryValidation->validateBet($bet,new CypherCastillo3DES(),$castillo_key,$castillo_ticket,$dateNextDraw, $line);
