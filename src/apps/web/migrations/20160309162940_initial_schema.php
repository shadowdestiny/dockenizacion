...
class InitialSchema extends AbstractMigration
{
    ...
    public function change()
    {
        if ($this->adapter->getOption('name') === "euromillions") {
            ...
            $this->execute('CREATE DATABASE euromillions;CHARACTER SET utf8 COLLATE utf8_unicode_ci');
            $this->execute('USE euromillions');
        }
        $this->execute('CREATE TABLE IF NOT EXISTS phinxlog (`version` bigint(20) NOT NULL,`migration_name` varchar(100) DEFAULT NULL,`start_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,`end_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, `breakpoint` TINYINT(1), PRIMARY KEY (`version`)) ENGINE=InnoDB DEFAULT CHARSET=utf8');
        ...
        $this->execute('CREATE TABLE users (id VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, surname VARCHAR(255) NOT NULL, country VARCHAR(255) NOT NULL, validated TINYINT(1) DEFAULT \'0\' NOT NULL, street VARCHAR(255) DEFAULT NULL, zip INT DEFAULT NULL, city VARCHAR(255) DEFAULT NULL, phone_number VARCHAR(20) DEFAULT NULL, jackpot_reminder TINYINT(1) DEFAULT \'0\', show_modal_winning TINYINT(1) DEFAULT \'0\', password VARCHAR(255) DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, remember_token VARCHAR(255) DEFAULT NULL, validation_token VARCHAR(255) DEFAULT NULL, wallet_uploaded_amount BIGINT DEFAULT NULL, wallet_uploaded_currency_name VARCHAR(255) DEFAULT NULL, wallet_winnings_amount BIGINT DEFAULT NULL, wallet_winnings_currency_name VARCHAR(255) DEFAULT NULL, user_currency_name VARCHAR(255) DEFAULT NULL, winning_above_amount BIGINT DEFAULT NULL, winning_above_currency_name VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB;');
