...
class EuroJackpotHelpController extends PublicSiteControllerBase
{
    public function indexAction()
    {
        ...
        $this->view->setVar('pageController', 'euroJackpotHowto');
        $this->view->pick('eurojackpot/howtoplay/index');
        return $this->view->setVars([
            ...
            'pageController' => 'euroJackpotHowto',
