...
final class SuperenalottoPlayTemporarilyController extends PowerBallPlayTemporarilyController
{
    ...
    public function temporarilyCartAction()
    {
        ...
        $this->result = $playService->savePlayFromJson(json_encode($playFormToStorage_collection),RedisOrderKey::create($current_user->getId(),7)->key());
        $this->redirectResult();
    }
    ...
    {
        parent::redirectResult('superenalotto'); // TODO: Change the autogenerated stub
    }
