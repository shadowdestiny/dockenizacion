    ...
    private function getAllUrls()
    {
        return [
            'en' => [
                ...
                'superenalottoNumbersIndex' => '/super-enalotto/results',
                'superenalottoNumbersPast' => '/super-enalotto/results/draw-history-page',
                'superenalottoPlay' => '/super-enalotto/play',
                'superenalottoHowto' => '/super-enalotto/how-to-play',
            ],
            'ru' => [
                'index' => '/ru',
                ...
                'superenalottoNumbersIndex' => '/ru/super-enalotto/результаты',
                'superenalottoNumbersPast' => '/ru/super-enalotto/результаты/история-розыгрышей',
                'superenalottoPlay' => '/ru/super-enalotto/играть',
                'superenalottoHowto' => '/ru/super-enalotto/как-играть',
            ],
            'es' => [
                'index' => '/es',
                ...
                'superenalottoNumbersIndex' => '/es/super-enalotto/resultados',
                'superenalottoNumbersPast' => '/es/super-enalotto/resultados/sorteos-anteriores',
                'superenalottoPlay' => '/es/super-enalotto/jugar',
                'superenalottoHowto' => '/es/super-enalotto/como-se-juega',
            ],
            'it' => [
                'index' => '/it',
                ...
                'superenalottoNumbersIndex' => '/it/super-enalotto/estrazioni',
                'superenalottoNumbersPast' => '/it/super-enalotto/estrazioni/archivio',
                'superenalottoPlay' => '/it/super-enalotto/gioca',
                'superenalottoHowto' => '/it/super-enalotto/come-giocare',
            ],
            'nl' => [
                'index' => '/nl',
                ...
                'superenalottoNumbersIndex' => '/nl/super-enalotto/uitslagen',
                'superenalottoNumbersPast' => '/nl/super-enalotto/uitslagen/trekking-geschiedenis',
                'superenalottoPlay' => '/nl/super-enalotto/speel',
                'superenalottoHowto' => '/nl/super-enalotto/speluitleg',
            ],
