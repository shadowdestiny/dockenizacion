    ...
    private function getAllUrls()
    {
        return [
            'en' => [
                ...
                'superenalottoNumbersIndex' => '/superenalotto/results',
                'superenalottoNumbersPast' => '/superenalotto/results/draw-history-page',
                'superenalottoPlay' => '/superenalotto/play',
                'superenalottoHowto' => '/superenalotto/how-to-play',
            ],
            'ru' => [
                'index' => '/ru',
                ...
                'superenalottoNumbersIndex' => '/ru/superenalotto/результаты',
                'superenalottoNumbersPast' => '/ru/superenalotto/результаты/история-розыгрышей',
                'superenalottoPlay' => '/ru/superenalotto/играть',
                'superenalottoHowto' => '/ru/superenalotto/как-играть',
            ],
            'es' => [
                'index' => '/es',
                ...
                'superenalottoNumbersIndex' => '/es/superenalotto/resultados',
                'superenalottoNumbersPast' => '/es/superenalotto/resultados/sorteos-anteriores',
                'superenalottoPlay' => '/es/superenalotto/jugar',
                'superenalottoHowto' => '/es/superenalotto/como-se-juega',
            ],
            'it' => [
                'index' => '/it',
                ...
                'superenalottoNumbersIndex' => '/it/superenalotto/estrazioni',
                'superenalottoNumbersPast' => '/it/superenalotto/estrazioni/archivio',
                'superenalottoPlay' => '/it/superenalotto/gioca',
                'superenalottoHowto' => '/it/superenalotto/come-giocare',
            ],
            'nl' => [
                'index' => '/nl',
                ...
                'superenalottoNumbersIndex' => '/nl/superenalotto/uitslagen',
                'superenalottoNumbersPast' => '/nl/superenalotto/uitslagen/trekking-geschiedenis',
                'superenalottoPlay' => '/nl/superenalotto/speel',
                'superenalottoHowto' => '/nl/superenalotto/speluitleg',
            ],
