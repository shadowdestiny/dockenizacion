...
use EuroMillions\web\vo\LastDrawDateEuroJackpot;
use EuroMillions\web\vo\PlayFormToStorage;

final class EuroJackpotPlayTemporarilyController extends PowerBallPlayTemporarilyController
{
    ...
    public function temporarilyCartAction()
    {
        ...
        $lastDrawDate = new LastDrawDateEuroJackpot($startDrawDate,$frequency);
        ...
        $this->result = $playService->savePlayFromJson(json_encode($playFormToStorage_collection),RedisOrderKey::create($current_user->getId(),5)->key());
        $this->redirectResult();
    }
    ...
    {
        parent::redirectResult('eurojackpot'); // TODO: Change the autogenerated stub
    }
