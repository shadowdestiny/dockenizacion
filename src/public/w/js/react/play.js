...
/******/ 	__webpack_require__.p = "/w/js/react";
/******/
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EuroMillionsBoxAction = __webpack_require__(167);
	var EuroMillionsMultipleEmLines = __webpack_require__(174);
	var EuroMillionsBoxBottomAction = __webpack_require__(175);
	var EmConfigPlayBlock = __webpack_require__(178);
	...
	var PlayPage = React.createClass({
	    ...
	    checkBetsConfirmed: function checkBetsConfirmed() {
	    ...
	    addLinesInStorage: function addLinesInStorage(e, line, numbers, stars) {
	    ...
	    handlerAddLines: function handlerAddLines(event) {
	    ...
	    mouseOverBtnAddLines: function mouseOverBtnAddLines() {
	        var current_lines = this.state.lines;
	        var default_lines = this.state.lines_default;
	        var allLinesFilled = this.checkBetsConfirmed();
	        var firstClick = current_lines.length == default_lines;
	    ...
	    handlerRandomAll: function handlerRandomAll() {
	        this.setState({ random_all: true });
	    },
	    handlerClearAll: function handlerClearAll() {
	        this.setState({ clear_all: true });
	    },
	
	    handleChangeDraw: function handleChangeDraw(value) {
	        switch (value) {
	            case 'Friday':
	                value = 1;
	                break;
	    ...
	    handleChangeDuration: function handleChangeDuration(value) {
	...
	ReactDOM.render(React.createElement(PlayPage, { lines_default: 5 }), document.getElementById('gameplay'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var EuroMillionsLineRow = __webpack_require__(160);
	var EuroMillionsLineStarsRow = __webpack_require__(162);
	var EuroMillionsClearLine = __webpack_require__(164);
	var EuroMillionsCheckMark = __webpack_require__(165);
	var EuroMillionsRandomBtn = __webpack_require__(166);
	
	var EuroMillionsLine = React.createClass({
	    displayName: 'EuroMillionsLine',
	    ...
	    handleClickOnNumber: function handleClickOnNumber(number) {
	    ...
	    handleClickOnStar: function handleClickOnStar(star) {
	    ...
	    handleClickOnClear: function handleClickOnClear() {
	    ...
	    handleClickRandom: function handleClickRandom() {
	        this.randomAll();
	    ...
	    render: function render() {
	        ...
	        for (var i = 1; i <= 50; i = i + j) {
	            ...
	            rows.push(React.createElement(EuroMillionsLineRow, { random_animation: this.state.isAnimated, numbers: row, onNumberClick: this.handleClickOnNumber,
	        ...
	        star_rows.push(React.createElement(EuroMillionsLineStarsRow, { numbers: star_numbers, onStarClick: this.handleClickOnStar, selectedNumbers: this.state.selectedNumbers,
	        ...
	        return React.createElement(
	            'div',
	            { onLoad: this.count, className: class_name },
	            React.createElement(
	                'h1',
	                { className: 'h3 blue center' },
	                'Line ',
	                linenumber
	            ),
	            React.createElement(
	                ...
	                React.createElement(EuroMillionsCheckMark, { numbers_length: numbers_length, stars_length: stars_length }),
	                React.createElement(
	                    'div',
	                    { className: 'combo cols not' },
	                    React.createElement(EuroMillionsRandomBtn, { line: this.props.lineNumber, onBtnRandomClick: this.handleClickRandom })
	                ),
	                React.createElement(
	                    'div',
	                    { className: 'values' },
	                ...
	                React.createElement(EuroMillionsClearLine, { showed: this.state.show_btn_clear, onClearClick: this.handleClickOnClear })
	            )
	        );
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var EuroMillionsNumber = __webpack_require__(161);
	
	var EuroMillionsLineRow = React.createClass({
	    displayName: 'EuroMillionsLineRow',
	    ...
	    render: function render() {
	        ...
	        this.props.numbers.forEach(function (number) {
	            ...
	            numbers.push(React.createElement(EuroMillionsNumber, { random_animation: random_animation, onNumberClick: onNumberClick, number: number, key: number, selected: selected }));
	        });
	        return React.createElement(
	            'ol',
	            { className: 'no-li cols not' },
	            numbers
	        );
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EuroMillionsNumber = React.createClass({
	    displayName: 'EuroMillionsNumber',
	    ...
	    render: function render() {
	        ...
	        var button = React.createElement(
	            'a',
	            { className: class_name, onClick: this.props.onNumberClick.bind(null, this.props.number), href: 'javascript:void(0);' },
	            this.props.number
	        );
	        return React.createElement(
	            'li',
	            { className: 'col20per not' },
	            button
	        );
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var EuroMillionsStar = __webpack_require__(163);
	
	var EuroMillionsLineStarsRow = React.createClass({
	    displayName: 'EuroMillionsLineStarsRow',
	    ...
	    render: function render() {
	        ...
	        this.props.numbers.forEach(function (number) {
	            selected = selected_numbers.indexOf(number) != -1;
	            numbers.push(React.createElement(EuroMillionsStar, { number: number, key: number, onStarClick: onStarClick, selected: selected,
	...
	var EuroMillionsStar = React.createClass({
	    ...
	    render: function render() {
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                'a',
	                { href: 'javascript:void(0);', onClick: this.props.onStarClick.bind(null, this.props.number), className: class_name },
	                React.createElement('svg', { className: 'vector v-star-out',
	                    dangerouslySetInnerHTML: { __html: '<use xlink:href="/w/svg/icon.svg#v-star-out"></use>' } }),
	                React.createElement('svg', { className: 'vector v-star',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EuroMillionsClearLine = React.createClass({
	    displayName: "EuroMillionsClearLine",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EuroMillionsCheckMark = React.createClass({
	    displayName: 'EuroMillionsCheckMark',
	    ...
	    render: function render() {
	        if (this.props.numbers_length == this.state.maxNumbers && this.props.stars_length == this.state.maxStars) {
	            return React.createElement('svg', { dangerouslySetInnerHTML: { __html: '<use xlink:href="/w/svg/icon.svg#v-checkmark"></use>' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EuroMillionsRandomBtn = React.createClass({
	    displayName: "EuroMillionsRandomBtn",
	    ...
	    render: function render() {
	        return React.createElement(
	            "div",
	            { className: "col6 not random" },
	            React.createElement(
	                "a",
	                { className: "btn gwy multiplay", onClick: this.props.onBtnRandomClick.bind(null, this.props.line), href: "javascript:void(0);" },
	                React.createElement("svg", { className: "v-shuffle",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var EuroMillionsAddLinesBtn = __webpack_require__(168);
	var EuroMillionsRandomAllBtn = __webpack_require__(172);
	var EuroMillionsClearAllBtn = __webpack_require__(173);
	
	var EuroMilliosnBoxActionPlay = React.createClass({
	    displayName: 'EuroMilliosnBoxActionPlay',
	
	    handlerAddLines: function handlerAddLines() {
	    ...
	    render: function render() {
	        ...
	        elem.push(React.createElement(EuroMillionsAddLinesBtn, { show_tooltip: this.props.show_tooltip, mouse_over_btn: this.props.mouse_over_btn, onBtnAddLinesClick: this.handlerAddLines, key: '1' }));
	        elem.push(React.createElement(EuroMillionsRandomAllBtn, { onBtnRandomAllClick: this.handlerRandomAll, key: '2' }));
	        elem.push(React.createElement(EuroMillionsClearAllBtn, { show_btn_clear: show_btn, onBtnClearAllClick: this.handlerClearAll, key: '3' }));
	
	        return React.createElement(
	            'div',
	            { className: 'cl', id: 'box-action' },
	            React.createElement(
	                'ul',
	                { className: 'no-li cl box-action' },
	                elem
	            )
	        );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var ReactTooltip = __webpack_require__(169);
	
	var EuroMillionsAddLinesBtn = React.createClass({
	    displayName: "EuroMillionsAddLinesBtn",
	    ...
	    render: function render() {
	        ...
	        var react_tooltip = React.createElement(ReactTooltip, { type: "light", id: "add-lines" });
	        ...
	        return React.createElement(
	            "li",
	            { "data-for": "add-lines", onTouchStart: this.props.onBtnAddLinesClick, onMouseOut: this.mouseLeave, onMouseOver: this.props.mouse_over_btn.bind(null, null), className: "box-more", "data-tip": "It is not possible to add more lines until you fill in the previous ones" },
	            React.createElement(
	                "a",
	                { className: "btn gwg add-more", onTouchEnd: this.props.onBtnAddLinesClick.bind(null, null), onClick: this.props.onBtnAddLinesClick.bind(null, null), href: "javascript:void(0);" },
	                "Add more lines",
	                React.createElement("svg", { className: "ico v-plus",
	...
	var EuroMillionsRandomAllBtn = new React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(
	                "a",
	                { className: "btn bwb random-all", onClick: this.props.onBtnRandomAllClick.bind(null, null), href: "javascript:void(0);" },
	                "Randomize all lines ",
	                React.createElement("svg", { className: "ico v-shuffle", dangerouslySetInnerHTML: { __html: '<use xlink:href="/w/svg/icon.svg#v-shuffle"></use>' } })
	            )
	        );
	    }
	    ...
	    render: function render() {
	        if (!this.props.show_btn_clear) {
	            ...
	            return React.createElement(
	                ...
	                React.createElement(
	                    "a",
	                    { className: "btn rwr random-all", onClick: this.props.onBtnClearAllClick.bind(null, null), href: "javascript:void(0);" },
	                    "Clear all lines ",
	                    React.createElement("svg", { className: "ico v-cross", dangerouslySetInnerHTML: { __html: '<use xlink:href="/w/svg/icon.svg#v-cross"></use>' } })
	                )
	            );
	        }
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EuroMillionsMultipleEmLines = React.createClass({
	    displayName: 'EuroMillionsMultipleEmLines',
	    ...
	    render: function render() {
	        ...
	        for (var i = 0; i <= numberEuroMillionsLine; i++) {
	            em_lines.push(React.createElement(EuroMillionsLine, { clear_all: this.props.clear_all, random: random, addLineInStorage: this.props.add_storage, storage: this.state.storage[i], callback: this.props.callback, numberPerLine: '5', key: i, lineNumber: i }));
	        }
	        return React.createElement(
	            'div',
	            { className: 'box-lines cl', id: 'box-lines' },
	            em_lines
	        );
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EuroMillionsAdvancedPlayBtn = __webpack_require__(176);
	var EuroMillionsAddToCart = __webpack_require__(177);
	
	var EuroMillionsBoxBottomAction = React.createClass({
	    displayName: 'EuroMillionsBoxBottomAction',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EuroMillionsAddToCart = new React.createClass({
	    ...
	    render: function render() {
	        ...
	        return React.createElement(
	            'a',
	            { href: 'javascript:void(0);', onClick: this.props.onBtnAddToCartClick, className: class_name },
	            React.createElement(
	                'span',
	                { className: 'value' },
	                '€ ',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var ThresholdPlay = __webpack_require__(179);
	var EmDrawConfig = __webpack_require__(182);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var EmCustomizableSelect = __webpack_require__(180);
	...
	var PlayPage = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            'div',
	            { id: 'wrap-threshold', className: 'col6 wrap-threshold' },
	            React.createElement(
	                'label',
	                { className: 'label', htmlFor: 'threshold' },
	                'Jackpot Threshold ',
	                React.createElement(
	                    'div',
	                    { 'data-tip': 'Set the condition when you want to play or to be informed automatically. Thresholds are calculated only in Euro.', className: 'wrap tipr-normal' },
	                    React.createElement('svg', { className: 'ico v-question-mark', dangerouslySetInnerHTML: { __html: '<use xlink:href="/w/svg/icon.svg#v-question-mark"</use>' } })
	                )
	            ),
	            React.createElement(
	                'div',
	                { className: 'box-threshold cl' },
	                React.createElement('input', { type: 'checkbox', className: 'checkbox', id: 'threshold', onChange: this.handleCheck }),
	                React.createElement(EmCustomizableSelect, _extends({}, this.props, { active: this.state.thresholdActive }))
	            )
	        );
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var EmSelect = __webpack_require__(181);
	
	var EmCustomizableSelect = React.createClass({
	    displayName: 'EmCustomizableSelect',
	    ...
	    render: function render() {
	        ...
	        var input = this.state.hideSelect ? React.createElement(
	            'span',
	            { className: 'input-value' },
	            React.createElement('input', { type: 'text', value: this.state.inputValue, onChange: this.handleInputChange, placeholder: 'Insert numeric value' })
	        ) : null;
	        var select = this.state.hideSelect ? null : React.createElement(EmSelect, {
	    ...
	    render: function render() {
	        ...
	        this.props.options.forEach(function (option) {
	            ...
	            options.push(React.createElement(
	                'option',
	                { value: option_value, key: option.value },
	                option.text
	            ));
	        });
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                'div',
	                { className: this.props.classDiv },
	                this.state.divText
	            ),
	            React.createElement(
	                'select',
	                { value: this.state.value, onChange: this.handleChange, className: this.props.classSelect, disabled: this.props.disabled },
	                options
	            )
	        );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EmSelectDraw = __webpack_require__(183);
	var EmSelectDrawDate = __webpack_require__(184);
	var EmSelectDrawDuration = __webpack_require__(185);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EmSelectDraw = React.createClass({
	    ...
	    render: function render() {
	        ...
	        var select = React.createElement(EmSelect, {
	            options: this.props.options,
	            defaultValue: this.props.defaultValue,
	            defaultText: this.props.defaultText,
	            onChange: this.handleChange,
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    'div',
	                    { className: 'wrap tipr-small', 'data-tip': 'Which draw do you want to play?' },
	                    React.createElement('svg', { className: 'ico v-question-mark',
	    ...
	    render: function render() {
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    'div',
	                    { className: 'wrap tipr-small', 'data-tip': 'First draw' },
	                    React.createElement('svg', { className: 'ico v-question-mark',
	                        dangerouslySetInnerHTML: { __html: '<use xlink:href="/w/svg/icon.svg#v-question-mark"></use>' } })
	                )
	            ),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EmSelectDrawDuration = React.createClass({
	    displayName: 'EmSelectDrawDuration',
	    ...
	    render: function render() {
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    'div',
	                    { className: 'wrap tipr-small', 'data-tip': 'For how long do you wish to play?' },
	                    React.createElement('svg', { className: 'ico v-question-mark',
	                        dangerouslySetInnerHTML: { __html: '<use xlink:href="/w/svg/icon.svg#v-question-mark"></use>' } })
	                )
	            ),
