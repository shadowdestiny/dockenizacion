...
/*********************************************************************
    ...
    $Id: ost-config.php 150 2014-11-05 13:11:37Z michaelg $
**********************************************************************/
...
define('SECRET_SALT','n9zgVo54jSj-vPGQFoTl4Y35uTuG0Szw');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','michael.graefe@telepronto.de');
...
define('DBTYPE','mysql');
define('DBHOST','tpl7');
define('DBNAME','euromillions_support');
define('DBUSER','root');
define('DBPASS','tpl7');
