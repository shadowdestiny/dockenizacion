...
class Tpl_Validator_Bic  extends Zend_Validate_Abstract 
{
    const NOT_MATCH = 'invalidBic';
	const INVALID        = 'swiftInvalid';
 
    protected $_messageTemplates = array(
        self::NOT_MATCH => 'No valid BIC'
    );
    ...
    protected $messageTemplates = array(
        self::NOT_MATCH       => 'The input does not match the SWIFT-BIC format',
