...
(function ($) {
    ...
    */      
    ...
    //buttons
    $.fn.editableform.buttons = '<button type="submit" class="editable-submit btn btn-primary btn-sm"><i class="glyphicon glyphicon-ok"></i></button>'+
    '<button type="button" class="editable-cancel btn btn-default btn-sm"><i class="glyphicon glyphicon-remove"></i></button>';
...
(function ($) {
    ...
    AbstractInput.defaults = {  
        ...
        **/         
        inputclass: 'input-sm form-control',
