...
class PlayServiceUnitTest extends UnitTestBase
{
    ...
    public function test_play_calledWithAUserWithOrderWithABetForNextDraw_chargeCreditCardWhenTheresNotEnoughFundsOnWallet()
    {
        ...
        $this->betService_double->groupingValidation(Argument::any(), Argument::any(),Argument::any())->willReturn(new ActionResult(true));
        ...
        $this->walletService_double->payGroupedBetsWithWallet($user,Argument::any())->shouldBeCalled();
