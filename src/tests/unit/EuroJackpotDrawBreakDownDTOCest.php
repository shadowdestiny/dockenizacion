...
class EuroJackpotDrawBreakDownDTOCest
{
    ...
    protected function getData()
    {
        return [
            ...
            ['category' => 'category_eight',  'name' => 'match-2-2',  'prize' => 1660,        'winners' => 57090],
            ['category' => 'category_nine',   'name' => 'match-3-1',  'prize' => 1710,        'winners' => 43366],
            ['category' => 'category_ten',    'name' => 'match-3',    'prize' => 1710,        'winners' => 35325],
