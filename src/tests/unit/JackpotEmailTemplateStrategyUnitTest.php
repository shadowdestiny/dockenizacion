...
class JackpotEmailTemplateStrategyUnitTest extends UnitTestBase
{
    ...
    {
        return new JackpotDataEmailTemplateStrategy($this->lotteriesDataService_double->reveal());
    }
    ...
    private function getDataTemplatesEmail()
    {
        ...
        return array($time_config, $draw_day_format_one, $draw_day_format_two, $money);
    }
