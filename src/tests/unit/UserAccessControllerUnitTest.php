...
class UserAccessControllerControllerBaseUnitTest extends UnitTestBase
{
    ...
    public function test_signUpAction_calledWithInvalidPassword_renderProperError($password)
    {
        ...
        $this->checkViewVarsContain('errors', ['The password should have at least one number, a lowercase and uppercase character.','Your password should be at composed by eight letters.']);
