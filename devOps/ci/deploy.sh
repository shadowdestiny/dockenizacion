...
sudo docker tag panamedialottery/euromillions-php:cron_${BUILD_IMAGE_TAG} panamedialottery/euromillions-php:cron
sudo docker push panamedialottery/euromillions-php:cron
